...
if (!fs.existsSync(path.join(`${basePath}/build/real`, "/metaSource"))) {
  fs.mkdirSync(path.join(`${basePath}/build/real`, "metaSource"));
}

let readDir = `${basePath}/build/real/json`;
let writeDir = `${basePath}/build/real/metaSource`;
